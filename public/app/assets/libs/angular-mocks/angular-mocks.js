 ...
 *
 * ```js
 *   var esgAppDev = angular.module('esgAppDev', ['esgApp', 'ngMockE2E']);
 *   esgAppDev.run(function($httpBackend) {
 ...
 *
 * ## Example
 * <example name="httpbackend-e2e-testing" module="esgAppE2E" deps="angular-mocks.js">
 * <file name="app.js">
 *   var esgApp = angular.module('esgApp', []);
 *
 *   esgApp.controller('MainCtrl', function MainCtrl($http) {
 *     var ctrl = this;
 *
 *     ctrl.phones = [];
 *     ctrl.newPhone = {
 ...
 * </file>
 * <file name="e2e.js">
 *   var esgAppDev = angular.module('esgAppE2E', ['esgApp', 'ngMockE2E']);
 *
 *   esgAppDev.run(function($httpBackend) {
 *     var phones = [{name: 'phone1'}, {name: 'phone2'}];
 *
...
(function(jasmineOrMocha) {
   ...
   * ```js
   *
   *   angular.module('esgApplicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('esgApp', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('esgApplicationModule'));
   *
   *
